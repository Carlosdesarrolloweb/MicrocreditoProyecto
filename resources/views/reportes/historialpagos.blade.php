...
<center>
    <div class="logo-container">
        <img class="logo" src="{{ asset('repopagos.png') }}" alt="Logo Microcréditos Mary">
        <h1 class="title">HISTORIAL PAGOS</h1>
...
@section('css')
    ...
    <link rel="stylesheet" href="{{ asset('ruta/a/tu/powergrid-custom.css') }}">
    <style>
